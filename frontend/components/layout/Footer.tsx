...
const Footer = () => {
  return (
    <footer className="bg-gray-50 dark:bg-accent-1 py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
              Connecting generations through meaningful activities, fostering
              deep relationships between elderly individuals and the younger
              generation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <span>contact@eternalink.com</span>
              </li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 text-center text-gray-500 dark:text-gray-400">
          <p>© {new Date().getFullYear()} EternaLink. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
